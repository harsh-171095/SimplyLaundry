...
@objc protocol DropDownDeledate: class {
...
public final class DropDown: UIView {
    ...
    weak var taponDissmissDalegate  : DropDownDeledate?
...
extension DropDown {
	...
	fileprivate func dismissableViewTapped() {
		cancel()
        NotificationCenter.default.post(name: NSNotification.Name("TapOndismissAction"), object: nil)
	}
